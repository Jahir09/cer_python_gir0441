...
Modulo 4
'''
print("Juego del gato contra la PC")
print()
...
def EnterMove(board):
	ok = False	
	while not ok:
		move = input("Pon aqui tu numero de movimiento: ") 
		ok = len(move) == 1 and move >= '1' and move <= '9' 
		if not ok:
			print("casilla ocupada intentemos de nuevo") 
			continue
		move = int(move) - 1 	
		row = move // 3 	#The rows
